-- CreateEnum
CREATE TYPE "Programme" AS ENUM ('mkd', 'serenity', 'mizzy');

-- CreateEnum
CREATE TYPE "Statut" AS ENUM ('a_demarrer', 'en_cours', 'termine');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('assignation', 'statut');
...
CREATE TABLE "Task" (
    ...
    "statut" "Statut" NOT NULL DEFAULT 'a_demarrer',
    "notes" TEXT,
    "assigneeId" TEXT,
